...
#Searching over different #s of exploration phase iterations before integrating, change line 35 to alter this parameter
...
exploration_phase_iterations = 100
...
r_2 = obj_record2
np.save('exploration_100',obj_record2)
